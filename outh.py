...
consumer_key = 'jira-flask-consumer'
consumer_secret = 'dont_care'

request_token_url = 'https://jira-entwf.allstate.com/plugins/servlet/oauth/request-token'
access_token_url = 'https://jira-entwf.allstate.com/plugins/servlet/oauth/access-token'
authorize_url = 'https://jira-entwf.allstate.com/plugins/servlet/oauth/authorize'

data_url = 'https://jira-entwf.allstate.com/rest/api/2/issue/IDD-1'
